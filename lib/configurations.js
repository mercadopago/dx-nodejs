...
var userAgent = 'MercadoPago Node.js SDK v' + sdkVersion + ' (node ' + process.version + '-' + process.arch +
  '-' + process.platform + ')';
var INSIGHT_DEFAULT_BASE_URL = 'https://events.mercadopago.com/v2/';
var INSIGHTS_API_ENDPOINT_METRIC = 'metric';
var INSIGHTS_API_ENDPOINT_TRAFFIC_LIGHT = 'traffic-light';
var CLIENT_NAME = "MercadoPago-SDK-NodeJS";
var METRICS_SCOPE = 'prod';
...
/**
 * Get base URL for Insight Metrics
 * @returns {string}
 */
configurationsModule.getBaseInsightMetricsUrl = function () {
  return INSIGHT_DEFAULT_BASE_URL;
};

/**
 * Get API Endpoint of Insight Metrics
 * @returns {string}
 */
configurationsModule.getInsightMetricsApi = function () {
  return INSIGHTS_API_ENDPOINT_METRIC;
};

/**
 * Get API Endpoint of Insight Metrics Traffic Light
 * @returns {string}
 */
configurationsModule.getInsightMetricsTrafficLightApi = function () {
  return INSIGHTS_API_ENDPOINT_TRAFFIC_LIGHT;
};
 ...
 * @returns {string}
 */
configurationsModule.getClientName = function () {
  return CLIENT_NAME;
};
 ...
 * @returns {string}
 */
configurationsModule.getVersion = function () {
  return sdkVersion;
};
 ...
 * @returns {string}
 */
configurationsModule.getMetricsScope = function () {
